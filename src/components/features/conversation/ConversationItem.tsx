...
import { canTransferGroupOwner } from "#/modules/group";
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
...
import { Ban, Crown, LogOut, MessageSquare, Trash2 } from "lucide-react";
import { useState } from "react";
import { LeaveGroupDialog, TransferOwnerDialog } from "#/components/features/group";
...
export function ConversationItem({
  ...
  const { active, select, block, unblock, hide } =
    ...
    <>
      <ContextMenu>
        ...
        <ContextMenuContent>
          ...
          {isGroup && canTransfer ? (
            <ContextMenuItem onSelect={() => setTransferring(true)}>
              <Crown />
